...
dist-build:
	...
	docker build --build-arg TAG=$(TAG) -t comporg/compbaseball_tasks:$(TAG) --file dockerfiles/projects/Dockerfile.compbaseball_tasks ./ && \
	docker build --build-arg TAG=$(TAG) -t comporg/taxbrain_tasks:$(TAG) --file dockerfiles/projects/Dockerfile.taxbrain_tasks ./
...
dist-push:
	...
	docker push comporg/taxbrain_tasks:$(TAG)
